...
function handleInputChange3(event) {
  ...
  const Purchase = async () => {
    ...
    var contractaddress = '0x6A6547aefABF263c6bcdAF36f78dc26C4a22a434';
    ...
    var contractaddress_token = '0xb42c6b327fdfbf19512fa03e93fc47c01e0ca931';
...
<div  >
      ...
      <div style={{marginTop :"8%"}} className="row">
        <div className="">
          <div className="card no-hover staking-card single-staking">
            <h3 className="m-0">Check Wallet by Purchase ID </h3>
            ...
            <div className="tab-content mt-md-3" id="myTabContent">
              ...
              <div style={{marginTop:"2%"}} className="input-area d-flex flex-column flex-md-row">
                ...
                <div  className="input-text">
                  ...
                  <input value={ inputValue1 }  onChange={handleInputChange1 }  placeholder="Enter Purchase ID" />
...
<p> Active Purchase ID : <span> {active} </span> </p>
<p> Current Purchase ID : <span> {active1} </span> </p>
</div>
      ...
      <div  style={{marginTop :"8%"}} className="row1">
        <div className="">
          <div className="card no-hover staking-card single-staking">
            <h3 className="m-0">Detail of Your Purchase ID </h3>
