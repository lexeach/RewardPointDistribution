...
function handleInputChange3(event) {
  ...
  useEffect(()=>{
    ...
    settosend(referrer.substr(referrer.length - 1))
  ...
  const Purchase = async () => {
    ...
    var contractaddress = '0x6C8B7dE88dFd4afcF681768b432Fa836CA572e67';
    ...
    var contractaddress_token = '0x9c3b5a294D357b6b4A5c3Df28FCb11891CB4025D';

    const instance = new web3.eth.Contract(abi, contractaddress);
    const instance_token = new web3.eth.Contract(abi_token, contractaddress_token);


    var payfess =  inputValue * 100000 ;
      ...
      <div className="row">
        <div className="">
          <div className="card no-hover staking-card single-staking">
            <h3 className="m-0">Purchaser Dashboard </h3>
...
/>
              ...
              <div className="input-area d-flex flex-column flex-md-row">
                ...
                <a onClick={Purchase} href="#" className="btn input-btn mt-2 mt-md-0 ml-md-3">Purchase</a>
              </div>
            </div>
                </div>
              </div>
...
<div  >
      ...
      <div style={{marginTop :"8%"}} className="row">
        <div className="">
          <div className="card no-hover staking-card single-staking">
            <h3 className="m-0">Pool1 user List </h3>
            ...
            <div className="tab-content mt-md-3" id="myTabContent">
              ...
              <div style={{marginTop:"2%"}} className="input-area d-flex flex-column flex-md-row">
                ...
                <div  className="input-text">
                  ...
                  <input value={ inputValue1 }  onChange={handleInputChange1 }  placeholder="Level Price" />
...
<p> Pool 1 Active User ID : <span> {active} </span> </p>
<p> Pool 1 Current User ID : <span> {active1} </span> </p>
</div>
      ...
      <div  style={{marginTop :"8%"}} className="row1">
        <div className="">
          <div className="card no-hover staking-card single-staking">
            <h3 className="m-0">Pool1 Users </h3>
  ...
  <tr  >
    ...
    <td> {users.payment_received}</td>
  
  </tr>

  <tr  >
    <td>Total Reward</td>
    <td> {users.totalReward}</td>
