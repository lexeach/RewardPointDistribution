...
function errorCallback (err) {
  ...
  const LEVEL_PRICEs = async () => {
    ...
    // var lvlp =  await instance.methods.LEVEL_PRICE(info).call();
    // setLvlPrice(lvlp / 100);
console.log("start");
    // let transferSubscription = instance.events.regPoolEntry();
    // console.log(transferSubscription._events);
...
// Registration
  ...
  const Register = async () => {
    ...
    .then(async ()=>{
      ...
      await instance.methods.Registration( Id , Fees).send({ from : accounts[0] , value : 0});
...
<div >
      ...
      <div style={{marginTop :"8%"}} className="row">
        <div className="">
          <div className="card no-hover staking-card single-staking">
            <h3 className="m-0">Check wallet By Merchant ID </h3>
